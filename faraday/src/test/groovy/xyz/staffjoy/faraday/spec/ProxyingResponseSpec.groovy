package com.knewton.planner.faraday.spec

import static com.knewton.planner.faraday.assertions.Assertions.assertThat
import spock.lang.Unroll
import com.knewton.planner.faraday.BasicSpec
...
class ProxyingResponseSpec extends BasicSpec {
    ...
    def "Should get proxied HTTP response with preserved status when destination response status is success #status"() {
        ...
        when:
        def response = sendRequest GET, 'www.planner-v2.local', '/path/1'
