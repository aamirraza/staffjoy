package com.knewton.planner.web.view;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import com.knewton.planner.common.config.StaffjoyProps;
...
public class PageFactory {
    ...
    public Page buildHomePage() {
        return Page.builder()
                .title("Planner  - Online Scheduling Software")
                .description("Planner  is a web application that helps small businesses create schedules online and automatically communicate them via text message with hourly workers.")
                .templateName("home")
    ...
    public Page buildAboutPage() {
        return Page.builder()
                ...
                .description("Learn about the members of the Planner  team and the origin of the company.")
                .templateName("about")
                .version(StaffjoyProps.getDeployEnv())
                .build();
    }
    ...
    public Page buildSignupPage() {
        return Page.builder()
                .title("Planner  Privacy Policy")
                .description("Sign Up for Your 30 Day Free Planner  Trial\", Description: \"Sign up for a 30 day free trial of Planner  today to create your schedule online. We’ll distribute it to your team using automated text messages.")
                .templateName("signup")
                .cssId("sign-up")
                .version(StaffjoyProps.getDeployEnv())
                .build();
    ...
    public Page buildTermsPage() {
        return Page.builder()
                .title("Planner  Terms and Conditions")
    ...
    public Page buildNewCompanyPage() {
        return Page.builder()
                ...
                .description("Get started with a new Planner  account")
    ...
    public LoginPage buildLoginPage() {
        return LoginPage.childBuilder()
                .title("Planner  Log in")
                .description("Log in to Planner  to start scheduling your workers. All you’ll need is your email and password.")
                .templateName("login")
                .cssId("login")
                .version(StaffjoyProps.getDeployEnv())
                .build();
    ...
    public ResetPage buildResetPage() {
        return ResetPage.childBuilder()
                ...
                .cssId("sign-up")
                .templateName("reset")
                .description("Reset the password for your Planner  account.")
    ...
    public ConfirmResetPage buildConfirmResetPage() {
        return ConfirmResetPage.childBuilder()
                .title("Reset your Planner  password")
                .description("Follow steps to reset your Planner  password")
                .cssId("sign-up")
