package com.knewton.planner.company.client;
...
import com.knewton.planner.company.CompanyConstant;
import com.knewton.planner.company.dto.*;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.validation.annotation.Validated;
import org.springframework.web.bind.annotation.*;

@FeignClient(name = CompanyConstant.SERVICE_NAME, path = "/v1/company", url = "${planner.company-service-endpoint}")
